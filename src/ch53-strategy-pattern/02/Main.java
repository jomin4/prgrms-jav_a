...
abstract class 비행아이템 extends 아이템 {
}
...
abstract class 수영아이템 extends 아이템 {
}

class 둥둥수영아이템 extends 수영아이템 {
    @Override
    public void 작동() {
...
abstract class 오리 {
    // protected 접근제어자는 private 처럼 외부에서 접근이 불가능, 단 private 와 달리 자식 클래스에서는 접근 가능
